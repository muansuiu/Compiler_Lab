...
public class Main
{
    ...
    static void File_Input() throws IOException
    {
        ...
        try
        {
            ...
            FileWriter fw1 = new FileWriter("E:\\8th Trimester\\Compiler LAB\\Assignment_3\\infix_input.txt");
        ...
        FileReader file = new FileReader("E:\\8th Trimester\\Compiler LAB\\Assignment_3\\infix_input.txt");
        ...
        try
        {
            FileWriter fw = new FileWriter("E:\\8th Trimester\\Compiler LAB\\Assignment_3\\infix_input.txt");
            assert result != null;
            fw.write("\n"+result);
